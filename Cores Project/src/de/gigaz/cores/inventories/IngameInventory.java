...
public class IngameInventory {
	...
	public static InventoryClass getInventory(Team team) {
		...
		put(7, new InventorySlot(
				...
				new InventoryItem(6, new ItemBuilder(Material.SNOWBALL).build(), new DisplayCondition() {@Override public boolean getCondition() {return Gamerules.getValue(Gamerules.snowball)&&!Gamerules.isValue(Gamerules.snowball, 6);}}, new ItemAmount() {@Override public int getAmount() {return (int) Math.pow(2, Gamerules.getValue(Gamerules.snowball, true)+1);}}),
				new InventoryItem(6, new ItemBuilder(Material.SNOWBALL).setName("§6Infinity Snowball").addEnchantment(Enchantment.ARROW_INFINITE, 10).setBreakable(false).build(), new DisplayCondition() {@Override public boolean getCondition() {return Gamerules.isValue(Gamerules.snowball, 6);}}),
				...
				new InventoryItem(6, new ItemBuilder(Material.ENDER_PEARL).build(), new DisplayCondition() {@Override public boolean getCondition() {return Gamerules.getValue(Gamerules.enderpearl)&&!Gamerules.isValue(Gamerules.enderpearl, 6);}}, new ItemAmount() {@Override public int getAmount() {return (int) Math.pow(2, Gamerules.getValue(Gamerules.enderpearl, true)-1);}}),
				new InventoryItem(6, new ItemBuilder(Material.ENDER_PEARL).setName("§6Infinity Enderpearl").addEnchantment(Enchantment.ARROW_INFINITE, 10).setBreakable(false).build(), new DisplayCondition() {@Override public boolean getCondition() {return Gamerules.isValue(Gamerules.enderpearl, 6);}}),
